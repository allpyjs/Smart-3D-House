...
const houseItems = [
  ...
  { label: "Roof-1", value: "leftRoof" },
  { label: "Roof-2", value: "rightRoof" },
  { label: "EXT-1", value: "frontWall" },
  { label: "EXT-2", value: "leftWall" },
  { label: "EXT-3", value: "rightWall" },
  { label: "EXT-4", value: "backWall" },
];
...
const PostFrame = ({ params, setParams }) => {
  ...
  return (
    <div className="flex flex-col">
      <div className="table-row bg-white w-full overflow-x-auto">
...
const AdvancedEdit = ({ params, setParams }) => {
  ...
  const handleExportSTL = () => {
    ...
    if (!house) return;
    const filename = selectedPart ? `house - ${selectedPart}` : 'house';
    exportSTL(house, `${filename}.stl`);
  };
  ...
  const handleExportGLTF = () => {
    ...
    if (!house) return;
    const filename = selectedPart ? `house - ${selectedPart}` : 'house';
    exportGLTF(house, `${filename}.gltf`);
  };
  ...
  return (
    <div className="flex items-center flex-wrap justify-between h-full overflow-hidden">
      <div className="flex flex-col shrink-0 grow basis-0 overflow-x-hidden h-full">
        ...
        <div className="flex grow shrink-0 basis-0">
          ...
          <div className="relative grow shrink-0 basis-0 bg-sky-100 flex flex-col items-stretch justify-stretch overflow-hidden">
            <House {...params} selectedPart={selectedPart} sceneRef={sceneRef} />
          </div>
        </div>
      </div>
